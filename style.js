...
module.exports = {
  ...
  "sources": {
    "openmaptiles": {
      "type": "vector",
      "url": `http://${sourcesUrl}hsl-vector-map/index.json`,
    }
  },
  "sprite": "https://raw.githubusercontent.com/maanteeamet/hsl-map-server/estonia/sprites/bright-v9",
  "glyphs": "https://raw.githubusercontent.com/maanteeamet/hsl-map-server/estonia/glyphs/{fontstack}/{range}.pbf",
  "layers": [
    {
      "id": "background",
      "type": "background",
